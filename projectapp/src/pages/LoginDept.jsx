...
export default function LoginDept(){
    ...
    const handleSubmit = async (e)=>{
        ...
        const response = await fetch(`https://backend-92s7.onrender.com/api/v1/users/dept/login`,{
            method : 'POST',
            headers : {
        ...
        const res = await fetch(`https://backend-92s7.onrender.com/api/v1/users/${resData.data.user.id}`)
